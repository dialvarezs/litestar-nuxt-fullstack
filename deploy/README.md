...
1. Start the pod for a test run: `podman kube play app-pod.yaml`
2. Check if the containers  are running with `podman ps`
...
4. Start and enable the service: `systemctl --user start app-pod.service`
